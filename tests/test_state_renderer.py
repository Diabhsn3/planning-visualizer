...
from src.state_renderer import RendererFactory, RenderedState
...
def test_blocks_world_renderer():
    ...
    domain_path = PROJECT_ROOT / "domains/blocks_world/domain.pddl"
    problem_path = PROJECT_ROOT / "domains/blocks_world/p1.pddl"
    ...
    output_file = PROJECT_ROOT / "output" / "blocks_world_rendered.json"
...
def test_gripper_renderer():
    ...
    domain_path = PROJECT_ROOT / "domains/gripper/domain.pddl"
    problem_path = PROJECT_ROOT / "domains/gripper/p1.pddl"
    ...
    output_file = PROJECT_ROOT / "output" / "gripper_rendered.json"
    with open(output_file, 'w') as f:
        f.write(json_output)
...
def test_rendered_state_format():
    ...
    from src.state_renderer import VisualObject, VisualRelation, RenderedState
