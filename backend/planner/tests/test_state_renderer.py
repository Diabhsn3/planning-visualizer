...
################## sola
def test_hanoi_renderer():
    """Test Hanoi renderer with state sequence."""
    print("\n" + "=" * 60)
    print("Testing Hanoi Renderer")
    print("=" * 60)

    domain_path = PLANNER_DIR / "domains/hanoi/domain.pddl"
    problem_path = PLANNER_DIR / "domains/hanoi/p1.pddl"
    ...
    output_file = PLANNER_DIR / "output" / "hanoi_rendered.json"
