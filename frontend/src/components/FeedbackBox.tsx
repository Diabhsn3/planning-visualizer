...
interface FeedbackBoxProps {
  ...
  disabled?: boolean;
  /** Horizontal, single-row layout (fits a short bar next to the playback controls). */
  compact?: boolean;
}
...
export function FeedbackBox({ context, getImageDataUrl, disabled, compact }: FeedbackBoxProps) {
